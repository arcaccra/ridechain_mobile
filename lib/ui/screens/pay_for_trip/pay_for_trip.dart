    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(child: DottedBorder(
                options: RectDottedBorderOptions(color: AppColors.purple),
                child: SizedBox(
                width: 1.sw,
                height: 217.h,
          ...
          Gap(20.h),
          Text(Label.completePayment, style: AppThemes.getCustomTextStyle(color: AppColors.lightPurple, fontSize: 11, weight: FontWeight.w800, fontFamily: "Outfit")),
          Gap(20.h),
          Container(
