        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text(pickupLocation ?? Label.pickup, style: AppThemes.getCustomTextStyle(color: AppColors.greyAd, fontSize: 13, weight: FontWeight.w700, fontFamily: "Outfit")),
            ],
          ),
          ...
          Row(
            children: [
              ...
              const Spacer(),
              Text(destinationLocation ?? Label.destination, style: AppThemes.getCustomTextStyle(color: AppColors.greyAd, fontSize: 13, weight: FontWeight.w700, fontFamily: "Outfit")),
            ],
          ),
        ],
      ),
